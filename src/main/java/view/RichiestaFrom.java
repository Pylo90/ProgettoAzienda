 ...
 */
public class RichiestaFrom extends javax.swing.JFrame {

    /**
     * Creates new form RichiestaFrom
     */
    public RichiestaFrom() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RichiestaFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RichiestaFrom().setVisible(true);
            }
        });
    }
