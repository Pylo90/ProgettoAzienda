 ...
 * @author dario
 */
public class CalendarioOreServizio extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalendarioOreServizio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalendarioOreServizio().setVisible(true);
            }
        });
    }
